...
class Graph:
    def __init__(self, node_count: int, aliases: list[str], bidirectional: bool = True):
...
# Simple Graph
simple_graph: Graph = Graph(5, [chr(65 + i) for i in range(5)])
...
# Complex Graph
complex_graph: Graph = Graph(20, [chr(65 + i) for i in range(20)])
